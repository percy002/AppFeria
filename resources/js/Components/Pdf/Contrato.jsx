        ...
        <Page size="A4" style={styles.page}>
            <View>
                ...
                <Text style={styles.textBase}>
                    Domicilio de la Entidad: plaza de armas
                </Text>
                <Text style={styles.textBase}>
                    Domicilio de la Contratada: Huancaro
                </Text>
                <Text style={styles.textBase}>
                    La variacion del domicilio aqui declarado de alguna de las
                    partes de be ser comunicada a ala otra parte formalmente y
                    por escrito, con una anticipacion no menor de quince dias
                    calendario.
                </Text>
                ...
                <View style={styles.signature}>
                    <View style={styles.signatureBody}>
                        ...
                        <Text style={styles.signatureText}>La Municipalidad</Text>
                    </View>
                    <View style={styles.signatureBody}>
                        <View style={styles.signatureLine} />
        ...
        <Page size="A4" style={styles.page}>
            <View>
                <Text style={styles.textBase}>
                    ...
                    el cual incluye versiones de Lorem Ipsum. ¿Por qué lo
                    usamos? Es un hecho establecido hace demasiado tiempo que un
                    lector se distraerá con el contenido del texto de un sitio
                    mientras que mira su diseño. El punto de usar Lorem Ipsum es
                    ...
                    español que se puede leer. Muchos paquetes de autoedición y
                    editores de páginas web usan el Lorem Ipsum como su texto
                    por defecto, y al hacer una búsqueda de "Lorem Ipsum" va a
                    dar por resultado muchos sitios web que usan este texto si
                    ...
                    humor y cosas por el estilo). ¿De dónde viene? Al contrario
                    del pensamiento popular, el texto de Lorem Ipsum no es
                    simplemente texto aleatorio. Tiene sus raices en una pieza
                    cl´sica de la literatura del Latin, que data del año 45
                    antes de Cristo, haciendo que este adquiera mas de 2000 años
                    de antiguedad. Richard McClintock, un profesor de Latin de
                    la Universidad de Hampden-Sydney en Virginia, encontró una
                    de las palabras más oscuras de la lengua del latín,
                    "consecteur", en un pasaje de Lorem Ipsum, y al seguir
                    leyendo distintos textos del latín, descubrió la fuente
                    indudable. Lorem Ipsum viene de las secciones 1.10.32 y
                    1.10.33 de "de Finnibus Bonorum et Malorum" (Los Extremos
                    del Bien y El Mal) por Cicero, escrito en el año 45 antes de
